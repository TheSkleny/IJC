...
#define AVG_LEN_MAX 10 //promyslet
#define AVG_LEN_MIN 5 //promyslet
...
//Itemy:
struct htab_item; //neúplná deklarace strutury pro htab_item
typedef struct htab_item htab_item_t; //typedef pro htab_item
